...
const getModuleName = (moduleFormat, minify = true) => `jupiter-scripts.${moduleFormat}${minify ? '.min.js': '.js'}`;

const getModulePath = (moduleFormat, minify = true) => `dist/lib/${getModuleName(moduleFormat)}`
